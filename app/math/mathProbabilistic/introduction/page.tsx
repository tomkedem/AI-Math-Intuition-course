  ...
  const steps = [
    {
      ...
      content: "אחרי שפגשנו את אבני הבניין בספר 'מתמטיקה אינטואיטיבית', אנחנו עוברים לשלב הבא. ניקח את הווקטורים, השיפועים וההסתברויות ונראה איך הם מתחברים למערכות קבלת החלטות אמיתיות וללוגיקה של מודלים גדולים.",
